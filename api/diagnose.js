...
BLACKLIST DETECTION: If the input contains a blacklist rejection, you MUST include a "blacklists" array in your JSON response alongside the other fields. Each item must use the exact blacklist name from this list so the UI can match it to a delisting URL:
- "Spamhaus ZEN"
- "SpamCop"
- "SORBS"
- "Barracuda"
...
"blacklists" array format:
[{ "name": "Spamhaus ZEN", "ip": "1.2.3.4" }]

If no blacklist is involved, omit the "blacklists" field entirely or set it to [].
